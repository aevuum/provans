  ...
  />
          ...
          <div className="lg:ml-10">
            ...
            <ul className="space-y-3 text-xl md:text-2xl font-sans">
              <li>
                <Link href="/catalog/all-category" className="hover:text-[var(--color-primary-200)] transition-colors duration-200">
                  Каталог
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/blog" className="hover:text-[var(--color-primary-200)] transition-colors duration-200">
                  Блог
                </Link>
              </li>
              {/* <li>
              ...
              <li>
                <Link href="/help" className="hover:text-[var(--color-primary-200)] transition-colors duration-200">
                  Помощь
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-xl md:text-2xl font-sans">
              ...
              <li>
                <span className="text-white/60 text-lg md:text-xl">Ежедневно с 10:00 до 21:00</span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col h-full justify-between ">
            <div>
              <div className="flex items-center gap-4 text-xl md:text-xl text-white/90 mb-8">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-15 h-12 text-[var(--color-primary-400)]" fill="currentColor" aria-hidden>
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5a2.5 2.5 0 110-5 2.5 2.5 0 010 5z" />
                </svg>
                <span>
                  Владимир, Большая Московская 19a
                </span>
              </div>
        ...
        <div className="mt-12 border-t border-white/20 pt-6 text-center text-lg md:text-xl text-white/60 font-light">
          © {new Date().getFullYear()} Provance Decor. Все права защищены.
        </div>
      </div>
    </footer>
  );
