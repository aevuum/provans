...
function AllCategoriesPageContent() {
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-8">Все категории</h1>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold">Все категории</h1>
      </div>
      ...
      <div className="grid lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <ReusableFilters 
            baseUrl="/catalog/все-категории-new"
          />
        </div>
