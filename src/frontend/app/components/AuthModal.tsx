      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div className="auth-tabs">
            <button
              className={`auth-tab ${activeTab === 'login' ? 'auth-tab--active' : ''} cursor-pointer`}
              onClick={() => switchTab('login')}
            >
              Вход
            </button>
            <button
              className={`auth-tab ${activeTab === 'register' ? 'auth-tab--active' : ''} cursor-pointer`}
        ...
        <div className="modal-body">
          <form onSubmit={handleSubmit} className="auth-form">
                  ...
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-600">
                      ...
                      <a 
                        href="/privacy-policy" 
                        target="_blank" 
                        className="text-[#7C5C27] hover:underline cursor-pointer"
                      >
            ...
            {error && (
              <div className="error-message mb-4 text-red-700 bg-red-50 border border-red-200 px-3 py-2 rounded">
                {error}
              </div>
            )}
            ...
            <>
              ...
              <div className="oauth-buttons">
                <button
                  ...
                  disabled={isLoading}
                  className="oauth-button oauth-button--google cursor-pointer"
                >
                  <FaGoogle />
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="oauth-button oauth-button--yandex cursor-pointer"
                >
