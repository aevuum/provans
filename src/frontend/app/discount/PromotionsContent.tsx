...
export default function PromotionsContent() {
  ...
  return (
  <section className="container mx-auto px-4 pt-0 md:pt-2 pb-16 md:pb-20 bg-mint-50 rounded-2xl relative">
      <div className="text-center mb-10">
        <h2 className="text-3xl md:text-4xl tracking-wider text-center mb-8 text-gray-800 section-heading">Специальное предложение</h2>
      </div>
