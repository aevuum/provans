  ...
  const emailHtml = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p>Здравствуйте, ${orderData.customerName}!</p>
       ...
       <p>Спасибо за ваш заказ в магазине декора Provance. Ваш заказ принят и обрабатывается.</p>
      ...
      <p style="color: #666; font-size: 14px;">
        С уважением,<br>
         Команда магазина декора Provance
      </p>
    </div>
  `;
...
export async function sendAdminOrderNotification(orderData: OrderEmailData): Promise<boolean> {
  const adminEmail = process.env.ADMIN_EMAIL || 'admin@provance-decor.ru';
